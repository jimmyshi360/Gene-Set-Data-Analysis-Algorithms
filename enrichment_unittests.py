...
class TestStattests(unittest.TestCase):
    ...
    def test_gen_table(self):
        anno = GMT("unittest_files\\test_go.gmt").genesets['0']
        sample = GMT("unittest_files\\test_gmt.gmt").genesets['0']
        background = BACKGROUND("unittest_files\\test_background.txt")
    ...
    def test_build_inputs(self):
        anno = GMT("unittest_files\\test_go.gmt")
        background = BACKGROUND("unittest_files\\test_background.txt")
    ...
    def test_binomial(self):
        anno = "unittest_files\\test_go.gmt"
        sample = "unittest_files\\test_gmt.gmt"
        background = "unittest_files\\test_background.txt"
        output= "unittest_files\\test_output.txt"
